...
const (
	...
	mainPkg = "turso"
	// modules:
	mainMod = "index" // the turso module
)

//go:embed cmd/pulumi-resource-turso/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-turso/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-turso/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "turso", turso.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-turso/provider".New
		...
		Keywords:   []string{"bchilcott", "turso", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/bchilcott/pulumi-turso/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("turso_", mainMod,
